---
title: Command Shortener CLI
description: Save and run long terminal commands with short, memorable aliases!
tags:
  [
    "axios",
    "boxen",
...
links:
  [
    { name: "GitHub", url: "https://github.com/Sajid-tech/command-shortner-cli" },
    { name: "Website", url: "https://www.npmjs.com/package/command-shortner?activeTab=code" },
